...
La versione 0.2.1 supporta i progetti salvati dalle versioni nightly attuali di
...
1. Chiudere KiCad.
2. Copiare l'intera cartella `kicad_backport` nella cartella utente `plugins`
   di KiCad.
