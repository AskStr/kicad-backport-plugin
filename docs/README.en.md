...
[release notes and validation boundaries](release-0.4.9.md).
...
See [regression coverage and validation](python-port-status.md#issue-4-schematic-annotations-and-power-nets).
...
unqualified compatibility claim. See [nightly compatibility and validation](nightly-format-support.md).
