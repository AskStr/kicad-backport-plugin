...
PCB/封装格式 `20260831` 等检查点。内置的 10.99 档位当前输出：符号库
`20260830`、原理图 `20260830`、PCB/封装 `20260831`。
...
本轮核对到 **2026-09-07 的 KiCad master `be90a7e200`**。新增线端形状会烘焙为
...
- 截至已核对的 2026-09-07 快照的 KiCad 10.99 每夜版文件
